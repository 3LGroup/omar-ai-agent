    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "notes" : {
                    "type": "string",
                    "description": "Note regarding the appointment. Default value of notes is `None`.",
                }

            },
            "required": ["doctor_name", "starts_at", "appointment_name", "clinic_name", "notes"],
        }
    }
}
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "starts_at": {
                    "type": "string",
                    "description" : "The start time of the appointment in the form of YYYY-MM-DDTHH:MM:SSZ. e.g 2024-08-13T11:00:00Z, make sure not to change/convert the time provided by the user. This time must be in future and in UTC 24HR. If user just provides the date then add time as T00:00:00Z",
                },
                "time_preference": {
                    "type": "string",
                    "description" : "The preferred time of the user, the values can be `exact`, `before`, or `after`. e.g before 11:00 AM, If user just provides the date then add time as T00:00:00Z",
                },
            },
            "required": ["doctor_name", "starts_at", "appointment_name", "clinic_name", "time_preference"],
        }
    }
}
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "starts_at": {
                    "type": "string",
                    "description": "The start time of the appointment in the form of YYYY-MM-DDTHH:MM:SSZ. e.g 2024-08-13T11:00:00Z, make sure not to change/convert the time that is provided by the user. Pass the same time in params that patient tells you. This time must be in future. Convert the time based on AM/PM to 24HR format.",
                },
                "appointment_type": {
                    "type": "string",
            ...
            "required": ["doctor_name","first_name", "last_name", "date_of_birth", "starts_at", "appointment_name" , "clinic_name", "notes"],
        }
    }
}
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "notes" : {
                    "type": "string",
                    "description": "Note regarding the reason for visit. Default value of notes is `None`.",
                }
                },
            "required": ["doctor_name","first_name", "last_name", "date_of_birth", "phone_number", "starts_at", "appointment_name", "clinic_name", "notes"],
        }
    }
}

get_patient_data_from_dynamo_schema={
    "type": "function",
    "function": {
        "name": "get_patient_data_from_dynamo",
        "description": "Get the patient details from dynamo.",
        "parameters": {
            "type": "object",
            "properties": {
                "first_name": { 
                  "type": "string",
                  "description": "The first name of the patient. pass `None` initally if not explicitly asked to be provided by the user.",
                },
                "last_name": {
                    "type": "string",
                    "description": "The last name of the patient. pass `None` initally if not explicitly asked to be provided by the user.",
                },
                "date_of_birth": {
                    "type": "string",
                    "description": "The date of birth of the patient in the form of YYYY-MM-DD, pass `None` initally if not explicitly provided by the user.",
                },
                "phone_number": {
                    "type": "string",
                    "description": "The mobile number of the patient , pass `None` initally if not explicitly provided by the user.",
                },
                
            },
            "required": ["date_of_birth" , "phone_number" , "first_name" , "last_name"],
        }
    }
}
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                "new_starts_date": {
                    "type": "string",
                    "description": "The new start date of the updated appointment in the form of YYYY-MM-DDTHH:MM:SSZ e.g. 2019-08-24T14:15:22Z,  make sure not to change/convert the time that is provided by the user. Pass the same time in params that patient tells you. The start time must be in the future. Convert the time based on AM/PM to 24HR format.",
                },
                "old_start_date": {
                    "type": "string",
                    "description": "The old start date of the appointment in the form of YYYY-MM-DDTHH:MM:SSZ e.g. 2019-08-24T14:15:22Z, Convert the time based on AM/PM to 24HR format.",
                },
                "first_name": {
                    "type": "string",
                    "description": "The first name of the patient.",
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {  
                ...
                "starts_at": {
                    "type": "string",
                    "description": "The start date of the appointment in the form of YYYY-MM-DDTHH:MM:SSZ e.g. 2019-08-24T14:15:22Z,  make sure not to change/convert the time that is provided by the user. Pass the same time in params that patient tells you. This time must be in future. Convert the time based on AM/PM to 24HR format.",
                },
                "cancellation_flag": {
                    "type": "string",
                    "description": "The default value of the cancellation_flag is `No`",
                },
            },
            "required": ["first_name", "last_name", "date_of_birth", "starts_at", "cancellation_flag" ],
        }
    }
}
