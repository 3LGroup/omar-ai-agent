    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "booking": {
                    "type": "string",
                    "description": "The booking value. It can be either True or False. If no value is provided, the default value will be False.",
                },
            },
            "required": ["to_number", "clinic_name", "booking" ],  # Correctly defined as an array of required fields
        },
    },
}
...
get_next_available_slot_schema = {
    ...
    "function": {
        ...
        "parameters": {
            ...
            "required": ["business_id","doctor_name", "starts_at", "appointment_name", "clinic_name", "notes", "context", ],
        }
    }
}
...
create_appointment_new_patient_schema = {
    ...
    "function": {
        ...
        "parameters": {
            ...
            "required": ["doctor_name","first_name", "last_name", "date_of_birth", "phone_number", "starts_at", "appointment_name" , "clinic_name", "notes", "context", ],
        }
    }
}
...
create_appointment_existing_patient_schema = {
    ...
    "function": {
        ...
        "parameters": {
            ...
            "required": ["first_name", "last_name","doctor_name", "date_of_birth", "starts_at", "appointment_name", "clinic_name", "notes", "context", ],
        }
    }
}
...
#         "description": "Get the patient details from cliniko.",
#         "parameters": {
#             "type": "object",
#             "properties": {
#                 "first_name": { 
...
get_patient_data_from_dynamo_schema={
    ...
    "function": {
        ...
        "parameters": {
            ...
            "required": ["date_of_birth" , "phone_number" , "first_name" , "last_name", "context", ],
        }
    }
}
...
cancel_individual_appointment_schema = {
    ...
    "function": {
        ...
        "parameters": {
            ...
            "required": ["first_name", "last_name", "date_of_birth", "starts_at", "cancellation_flag", "context", ],
        }
    }
}
